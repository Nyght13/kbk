...
#
define MAX_BUF 16384# define MAX_BUF_LIST 10# define BASE_BUF 1024

/* valid states */
# define BUFFER_SAFE 0# define BUFFER_OVERFLOW 1# define BUFFER_FREED 2
...
/* character recyling */
# define CD CHAR_DATA# define PD PC_DATA# define OC OLD_CHAR
