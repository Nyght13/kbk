...
#
define REDIT(fun) bool fun(CHAR_DATA * ch, char * argument)# define OEDIT(fun) bool fun(CHAR_DATA * ch, char * argument)# define MEDIT(fun) bool fun(CHAR_DATA * ch, char * argument)# define AEDIT(fun) bool fun(CHAR_DATA * ch, char * argument)
...
bool set_obj_values(CHAR_DATA * ch, OBJ_INDEX_DATA * pObj, int value_num, char * argument) {
    ...
    case ITEM_WAND:
        case ITEM_STAFF:
            switch (value_num) {
            default: do_help(ch, "ITEM_STAFF_WAND");
            return FALSE;
        case 0:
    ...
    case ITEM_SCROLL:
        ...
        case ITEM_PILL:
            switch (value_num) {
            default: do_help(ch, "ITEM_SCROLL_POTION_PILL");
            return FALSE;
        case 0:
                send_to_char("SPELL LEVEL SET.\n\r\n\r", ch);
            pObj - > value[0] = atoi(argument);
    ...
    case ITEM_WEAPON:
            switch (value_num) {
            default: do_help(ch, "ITEM_WEAPON");
            return FALSE;
        case 0:
    ...
    case ITEM_PORTAL:
            switch (value_num) {
            default: do_help(ch, "ITEM_PORTAL");
            return FALSE;
    ...
    case ITEM_FURNITURE:
            switch (value_num) {
            default: do_help(ch, "ITEM_FURNITURE");
            return FALSE;
    ...
    case ITEM_FOUNTAIN:
            switch (value_num) {
            default: do_help(ch, "ITEM_FOUNTAIN");
            /* OLC		    do_help( ch, "liquids" );    */
            return FALSE;
        case 0:
                send_to_char("MAXIMUM AMOUT OF LIQUID HOURS SET.\n\r\n\r", ch);
